...
\begin{quote} 
  ...
  variety of use cases. A Blockchain is a distributed system which means that
  processing is shared across multiple nodes. There are two major categories of
  Blockchain implementations. In this Chapter, the Blockchain technology and
  more specifically the Ethereum and Hyperledger Fabric platform
