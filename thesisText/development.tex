...
ease by providing an identity service and a controlled environment due to using
a membership service provider and a certificate authority, therefore avoiding
the same fate as \textbf{IoT} devices where the lack of security regulations
and ambiguity in how data collected by these devices is handled has stopped
these to be used in any official capacity.
...
% Falta falar sobre os principais componentes da plataform, de state database
% and blockchain to store , assets, chaincode execution
