...
the ak- knowledged challenges of delivering these in practice have stimulated a
considerable investment in research and development over the past decade.
...
consensus~\cite{Eichelberg2006} that was required for interoperability between
different Information Systems in Healthcare institutions. 
...
industries and the general public are becoming interested in this technological
advance that is laying the foundation for a change in the underlying flow of
our economic and social systems~\cite{Zago2018,Marr2018,Long2018}. Some
