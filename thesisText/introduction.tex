...
%The \textit{Cartão do Cidadão}, is a portuguese identification document that
%replaces four other identification documents, streamlining portuguese civilian
%identification.  This also allows many businesses to tailor their services to
%this document making it easier on both parts and eliminating unnecessary costs
%and risks.
